...
namespace EPiServer.Templates.Alloy.Business.ContentProviders
{
    ...
    {
        private static readonly ILog _logger = LogManager.GetLogger(typeof(ClonedContentProvider));
        ...
        private PageData ClonePage(PageData originalPage)
        {
            ...
            _logger.DebugFormat("Cloning page {0}...", originalPage.PageLink);
        ...
        private IList<ContentReference> FilterByCategory(IEnumerable<ContentReference> contentReferences)
        {
            ...
            {
                var content = contentReference.Get<IContent>() as ICategorizable;
